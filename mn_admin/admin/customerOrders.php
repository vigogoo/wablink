...
<p><i  class="icon-bar-chart"></i> Mini price</p>
...
<div class="widget">
<h3 class="section-title first-title"><i class="icon-table"></i> New Customer Orders</h3>
...
<tbody>
<?php 
$selx=mysqli_query($conn,"SELECT * from order_details where status='0'");
...
<a href="#0" onClick="getOrderDetails('<?php echo $order_details_id;?>');overlay('overlayMain')" class="btn btn-success btn-xs">
