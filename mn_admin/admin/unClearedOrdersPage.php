...
if(isset($_REQUEST['cmd'],$_REQUEST['order_id'])){
    ...
    header("Location:$site_name"."/mn_admin/admin/unClearedOrdersPage/");
}
...
/*function loadUpdates(){
  $('#newOrders').load('getOrders.php').fadeIn("slow");
  $('#clearedOrders').load('unClearedOrders.php').fadeIn("slow");
  $('#soldItems').load('soldItems.php').fadeIn("slow");
  $('#totalSales').load('totalSales.php').fadeIn("slow");
}
...
setInterval(function ()
{	
  $('#newOrders2').load('newOrders.php').fadeIn("slow");
}, 20000);


function getOrderDetails(id){
	//alert(id);
  $('#overlayM').load('orderDetails.php?id='+id);
}
            ...
            <div class="widget">
              ...
              <div class="widget-content-white glossed">
                ...
                <table class="table table-striped table-bordered table-hover datatable">
                  ...
                  <tbody>
<?php 
$selx=mysqli_query($conn,"SELECT * from order_details where status ='1'");
