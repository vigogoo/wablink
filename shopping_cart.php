          ...
          <div class="table-responsive">
              ...
              <fieldset>
                <table class="data-table cart-table" id="shopping-cart-table">
                  ...
                  <tfoot>
                    <tr class="first last">
                      <td class="a-right last" colspan="7"><button onclick="location.href='index.php'" class="button btn-continue" title="Continue Shopping" type="button"><span><span>Continue Shopping</span></span></button>
...
?>
   <tr class="last even">
                      <td class="image"><a class="product-image"  href="product_detail.php?item_id=<?php echo $ray['item_id']; ?>">
<img style="max-width: 80px" src='images/products/<?php  echo str_replace(".","_thumb.",$photo_name); ?>' alt='<?php echo $ray['item_name']; ?>' title='View details for\n<?php echo $ray['item_name']; ?>' class='img-responsive' />
                      ...
                      <td><h2 class="product-name"> <a href="product_detail.php?item_id=<?php echo $ray['item_id']; ?>"><?php echo $ray['item_name']; ?></a> </h2></td>
                      
                      <td class="a-right"><span class="cart-price"> <span class="price">UGX <?php echo number_format($np); ?></span> </span></td>
            ...
            <input style="color: #333; background-color: #f0f0f0" maxlength="12" class="input-text qty" title="Qty" size="4" value="<?php echo $qty; ?>" name="cart[15946][qty]"></td>
             <td class="a-right movewishlist"><span class="cart-price"> <span class="price">UGX<?php echo number_format($cost); ?></span> </span></td>
                      <td class="a-center last"><a onclick="delete_from_cart('<?php echo $item_id; ?>');" class="button remove-item" title="Remove item" href=""></a></td>
    </tr>
  ...
  <?php } ?>
                ...
                <table id="shopping-cart-totals-table" class="table shopping-cart-table-total">
                  ...
                  <tfoot>
                    <tr>
                      ...
                      <td class="a-right"><strong><span class="price">UGX <?php echo number_format($total_price); ?></span></strong></td>
                    </tr>
                  </tfoot>
                  <tbody>
                    <tr>
                      <td class="a-left" colspan="1"> Subtotal </td>
                      <td class="a-right"><span class="price">UGX <?php echo number_format($total_price); ?></span></td>
                    </tr>
                  </tbody>
                </table>
                <ul class="checkout">
    ...
    <?php
    for($i=0;$i<6;$i++){
    $best=mysql_query("SELECT *from item i inner join item_size s on(i.item_id=s.item_id) where expiry_date > CURDATE() ")  or die(mysql_error());
                              ...
                              <div class="info">
                                <div class="info-inner">
                                  ...
                                  <div class="item-content">
                                    ...
                                    <div class="price-box">
                                      <p class="special-price"> <span style="text-decoration: line-through;" class="price">UGX<?php echo number_format($ray['old_price']); ?></span> </p>
                                      <p class="old-price"> <span class="price-sep">-</span> <span class="price">UGX<?php echo number_format($ray['new_price']); ?></span> </p>
                                    </div>
                                  </div>
                                  <!--item-content--> 
                                </div>
